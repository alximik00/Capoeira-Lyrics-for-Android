...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    /**
     * Returns the RuntimeExceptionDao (Database Access Object) version of a Dao for our Song class. It will
     * create it or just give the cached value. RuntimeExceptionDao only through RuntimeExceptions.
     */
    public RuntimeExceptionDao<Song, Long> getSongDao() {
        if (simpleRuntimeDao == null) {
            simpleRuntimeDao = getRuntimeExceptionDao(Song.class);
        }
